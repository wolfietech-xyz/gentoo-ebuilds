...
IUSE="gtk-doc +miners +introspection stemmer test vala"
RESTRICT="!test? ( test )"

#Conflicts to block simultaneous installing of tinysparql-3; which provides newer versions of this package under a new name.
CONFLICTS="app-misc/tinysparql"
...
src_configure() {
	...
	local emesonargs=(
		...
		$(use introspection && echo "-Dintrospection=enabled")
