...
RDEPEND="
	...
	virtual/libtinysparql:3[miners]
...
#Conflict to block simutanous installs of this package, when the newer provider package; app-misc/localsearch is installed.
CONFLICTS="app-misc/localsearch"
