...
IUSE="daap chromaprint flickr freebox gnome-online-accounts lua test thetvdb tinysparql upnp-av +youtube"
RESTRICT="!test? ( test )"
...
RDEPEND="
	...
	tinysparql? ( virtual/libtinysparql:3 )
...
src_configure() {
	local emesonargs=(
		...
		-Denable-tmdb=yes
		-Denable-tracker=no
		-Denable-tracker3=$(usex tinysparql yes no)
